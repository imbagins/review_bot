...
def start_command_handler(message: types.Message):
 ...
 bot.send_message(
        ...
        text='Привет, я Морской Котик! Если ты читаешь это сообщение, то наверняка уже закончил курс QA Studio, и отправился в самостоятельное плавание. Расскажи, ты уже работаешь?', # текст сообщения
